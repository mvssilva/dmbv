...
void result_set_rbepseedfixa1(Result *r, float x)
{ 
    r->rbepseedfixa1 = x;
}

void result_set_rbepseedfixa100(Result *r, float x)
{
    r->rbepseedfixa100 = x;
}

void result_set_rbepseedfixa1000(Result *r, float x)
{
    r->rbepseedfixa1000 = x;
}
