...
void vector_add_rbepseedfixa1(Vector *v, float x, int indice)
{
    Result * r = &(v->data[indice]);
    result_set_rbepseedfixa1(r, x);

}

void vector_add_rbepseedfixa100(Vector *v, float x, int indice)
{
    Result * r = &(v->data[indice]);
    result_set_rbepseedfixa100(r, x);

}

void vector_add_rbepseedfixa1000(Vector *v, float x, int indice)
{
    Result * r = &(v->data[indice]);
    result_set_rbepseedfixa1000(r, x);
