...
void print_centralidades(igraph_t g_aux, int n, float vectorBt[], int dbranch[], string name_arquivo){
...
int main(int argc, char * argv[]){
    ...
    ofstream RBEPm("rbep_ils.csv", std::ios_base::app);
    ...
    // print_centralidades(g_aux, n, vectorBt, dbranch, argv[1]);
