...
def generate_latex_table(data):
    ...
    latex_code += "\\hline\n\\end{tabular}%\n}\n"
    latex_code += "\\caption{Resultados medios e 100 execuções minimos para instancias grandes, com seed da roleta inicializada com o valor de 0 a 100.}\n"
...
# Nome do arquivo CSV
filename = 'result-mean-large-fixo.csv'
